...
- [add MCP lazy loading](https://github.com/Broderick-Westrope/anvil/pull/22) on [Broderick-Westrope/anvil](https://github.com/Broderick-Westrope/anvil) (2 days ago)
...
- [ivankuznetsov/hive](https://github.com/ivankuznetsov/hive) - An agentic harness that runs your coding agents from idea to merged PR. Nine inspectable stages, markdown artefacts at every  step, drop in by hand whenever you want. Claude / Codex / Pi. (2 days ago)
- [bazelbuild/starlark](https://github.com/bazelbuild/starlark) - Starlark Language (2 days ago)
